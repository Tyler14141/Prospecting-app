...
export const CA_REGIONS = [
  ...
  {code:'PE',name:'PEI'},{code:'QC',name:'Quebec'},{code:'SK',name:'Saskatchewan'},{code:'YT',name:'Yukon'},
]
...
export const STATUS_OPTS = ['none','sent','opened','replied','booked'] as const
export type StatusKey = typeof STATUS_OPTS[number]
export const STATUS_LABELS: Record<StatusKey, string> = {
  none: 'Not sent', sent: 'Sent', opened: 'Opened', replied: 'Replied', booked: 'Call Booked',
}

export const AV_CLASSES = ['av-blue','av-green','av-amber','av-purple']
